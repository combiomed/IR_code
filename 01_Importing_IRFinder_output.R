...
TSS<-read.delim("/spectrum/GSCT/veronikap/DEEP/hg38_TSS.txt", header = T)

files<-read.table(file = "/home/veronikap/MONvsMAC/pathsMONvsMAC.txt", header = F)
...
all.introns<-read.delim("/spectrum/GSCT/veronikap/REF/Human-GRCh38-release86/introns.unique.bed", header = F) #This file is created using a modified perl script
...
genes.FPKM.files<-c("/spectrum/GSCT/veronikap/DEEP/cufflinks/BlMo_Hm01_genes.fpkm",
                    "/spectrum/GSCT/veronikap/DEEP/cufflinks/BlMo_Hm03_genes.fpkm",
                    "/spectrum/GSCT/veronikap/DEEP/cufflinks/BlMo_Hm05_genes.fpkm",
                    "/spectrum/GSCT/veronikap/DEEP/cufflinks/BlMa_Hm03_genes.fpkm",
                    "/spectrum/GSCT/veronikap/DEEP/cufflinks/BlMa_Hm05_genes.fpkm")
